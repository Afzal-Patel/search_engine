...
docker run -d --name=metahtml_warc_7$name --network=novichenko novichenko/downloader_warc --db=postgresql://$POSTGRES_USER:$POSTGRES_PASSWORD@db:5432/$POSTGRES_DB "--warc=$warc"
